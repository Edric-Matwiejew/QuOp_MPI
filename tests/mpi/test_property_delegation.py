...
class TestPropertyDelegation:
    ...
    def test_local_i_matches_layout(self, mpi_comm):
        """T6.1: After setup(), alg.local_i == alg.layout.local_i."""
    ...
    def test_partition_table_matches_layout(self, mpi_comm):
    ...
    def test_layout_none_after_destroy(self, mpi_comm):
        """T6.3: After destroy(), alg.layout is None."""
        alg = self._make_alg(mpi_comm)
        alg.setup()
        assert alg.layout is not None
    ...
    def test_mpi_comm_is_subcomm(self, mpi_comm):
