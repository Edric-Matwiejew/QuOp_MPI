...
class TestPauli:
    ...
    def test_pauli_commutation_XY_eq_iZ(self):
        ...
        np.testing.assert_array_almost_equal(commutator.toarray(), expected.toarray())
    ...
    def test_pauli_anticommutation(self):
        ...
        np.testing.assert_array_almost_equal(anticommutator.toarray(), np.zeros((2, 2)))
...
class TestToolkitIntegration:
    ...
    def test_kron_power_matches_multi_qubit_pauli(self):
        ...
        np.testing.assert_array_almost_equal(result.toarray(), np.diag(expected_diag))
