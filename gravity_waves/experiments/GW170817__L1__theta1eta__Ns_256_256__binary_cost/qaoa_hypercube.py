...
exp_name = f'{event_name}__{ifo}__{cds}__Ns_{Ns[0]}_{Ns[1]}__binary_cost'
...
alg = qaoa(Ntotal)
alg.set_qualities(cost_values_from_file_binary, {'args':[Ns, strides, deltas, mins, d, threshold, cost_file]})
alg.benchmark(
    range(1, pmax+1),
    repeats,
    param_persist=True,
