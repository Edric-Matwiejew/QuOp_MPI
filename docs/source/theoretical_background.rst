...
The following sections contain excerpts from:
...
Which are available as preprints on arXiv.


.. include:: ../background/combinatorial.rst

.. include:: ../background/multivariable.rst
