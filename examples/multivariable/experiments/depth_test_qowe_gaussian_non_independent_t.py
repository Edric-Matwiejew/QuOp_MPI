...
output = "results/depth_test_qowe_gaussian_non_independent_t"

for function in functions:

    basename = f"{output}/{function.name} d={d} n={nn}"
    suspend_path = f"suspend_data/depth_test_qowe_gaussian_non_independent_t/{function.name} d={d} n={nn}"
