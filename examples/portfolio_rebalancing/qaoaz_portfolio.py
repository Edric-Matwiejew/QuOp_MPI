...
UQ = diagonal.unitary(qaoaz_portfolio, parameter_function=param.rand.uniform)

UW = sparse.unitary(
    sparse.operator.serial,
    operator_kwargs={"function": mixer, "args": [n_qubits]},
...
alg.set_initial_state(state.serial, {"function": parity_state, "args": [n_qubits, 2]})
